                ...
                <div key={product._id} className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl">
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex justify-between items-center">
                      <button type="button" onClick={() => { setSelectedProduct(product); setIsProductModalOpen(true); }} className="flex items-center gap-2 bg-primary text-white px-4 py-2 rounded-lg hover:bg-secondary">
                        <ShoppingCart size={16} />View Product
                      </button>
                      <button type="button" className="p-2 border-2 border-gray-300 rounded-full hover:border-accent hover:text-accent"><Heart size={20} /></button>
                    </div>
                  </div>
                </div>
              ))}
